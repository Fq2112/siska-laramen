<head>
    ...
    <title>Applied Invitation List</title>
    <style type="text/css">
        /*Bootstrap*/
        .alert {
            padding: 15px;
                                                        ...
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <strong style="font-size: 22px">
                                                                    Here is the applied invitation list for your vacancy
                                                                </strong><br>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="alert alert-info text-center">
                                                    ...
                                                    applied invitation list of your vacancy.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <strong style="font-size: 20px">
                                                                    Keep an eye on the applied invitation of your
                                                                    other active vacancies</strong><br>To redirect you
                                                                to the Invited Seeker page, click the Invited Seeker
                                                                button below.
                                                            </small>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" width="600" class="full-width"
                                                            ...
                                                            <a class="zoom" id="activate"
                                                               href="{{route('agency.invited.seeker')}}"
                                                               target="_blank">
                                                                INVITED SEEKER</a>
                                                        </td>
                                                    </tr>
