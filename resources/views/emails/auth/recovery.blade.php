                            ...
                            Where is my new password?
                                                    ...
                                                    <tr>
                                                        <td align="center"><span class="pw-note" style="font-family: helvetica, arial;
                                                         font-size: 15px;
                                                         line-height: 22px;
                                                         display: block;">{{env('APP_NAME')}} doesn't make you remember yet another password or certain codes.<br>Just click the link and enter the new password that you want.</span>
                                                        </td>
                                                    </tr>
