                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" width="600" class="full-width"
                                                                ...
                                                                valign="top">
                                                                {{--<b class="zoom" id="activate">{{$promo->promo_code}}</b>--}}
                                                                <div class="dl">
                                                                    <div class="brand">
                                                                        <h2>Job Ads Posting Discount Voucher</h2>
                                                                    </div>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="footer-padding"
                                                                        ...
                                                                        bgcolor="#1a1c21">
                                                                        &copy; {{now()->format('Y').' '.env('APP_NAME')}}
                                                                        . All rights reserved. Ketintang, Gayungan,
                                                                        Ketintang, Gayungan, Surabaya, Jawa Timur —
                                                                        60231.<br><br><br>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
