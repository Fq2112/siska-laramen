<head>
    ...
    <title>{{env('APP_NAME')}} Partnership</title>
    <style type="text/css">
        /*Bootstrap*/
        .alert {
            padding: 15px;
                                                        ...
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <strong style="font-size: 22px">
                                                                    Here is the credentials for your SiskaLTE
                                                                </strong><br>
                                                                Thank you for using SiskaLTE and giving us the
                                        ...
                                        <tr>
                                            <td>
                                                <div class="alert alert-danger text-center">
                                                    Make sure not to inform this credentials
