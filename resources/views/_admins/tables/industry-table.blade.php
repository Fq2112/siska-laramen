...
@section('title', 'Industries Table &ndash; SISKA Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
    ...
    <script>
        ...
        function editIndustry(id, name, icon) {
            $('#editModalContent').html(
                ...
                'readonly style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="' + icon + '">' +
                '<span class="input-group-btn">' +
