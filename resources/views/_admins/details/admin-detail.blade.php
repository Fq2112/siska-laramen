...
@php $auth = Auth::guard('admin')->user(); @endphp
@section('title', ''.$auth->name.'\'s Details &ndash; SISKA Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
                                ...
                                <div id="crop-avatar">
                                    ...
                                    @if($auth->ava == "" || $auth->ava == "avatar.png")
                                        <img class="img-responsive avatar-view" title="Change the avatar"
                                             alt="avatar.png" src="{{asset('images/avatar.png')}}">
                                    @else
                                        <img class="img-responsive avatar-view" title="Change the avatar"
                                             alt="{{$auth->ava}}" src="{{asset('storage/admins/'.$auth->ava)}}">
                                    @endif
                                </div>
                            </div>
                            <h3>{{$auth->name}}</h3>
