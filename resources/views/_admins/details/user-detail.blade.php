...
@section('title', ''.$user->name.'\'s Details &ndash; SISKA Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
                            ...
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    ...
                                    @if($user->ava == "" || $user->ava == "seeker.png")
                                        <img class="img-responsive avatar-view" title="Change the avatar"
                                             alt="seeker.png" src="{{asset('images/seeker.png')}}">
                                    @elseif($user->ava == "agency.png")
                                        <img class="img-responsive avatar-view" title="Change the avatar"
                                             alt="agency.png" src="{{asset('images/agency.png')}}">
                                    @else
                                        <img class="img-responsive avatar-view" title="Change the avatar"
                                             alt="{{$user->ava}}" src="{{asset('storage/users/'.$user->ava)}}">
                                    @endif
                                </div>
                            </div>
                            <h3>{{$user->name}}</h3>
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                        ...
                                        <ul class="messages">
                                            <li>
                                                <img src="{{asset('_admins/images/img.jpg')}}" class="avatar"
                                                     alt="Avatar">
