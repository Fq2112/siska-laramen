...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-clock"></i> Average Time</span>
                <div class="count">123.50</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-up"></i>3% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-user"></i> Total Males</span>
                <div class="count green">2,500</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-up"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    ...
                    <div class="x_content">
                        <div class="dashboard-widget-content">
                            <ul class="quick-list">
                                ...
                                <li><i class="fa fa-chart-bar"></i><a href="#">Auto Renewal</a></li>
                                <li><i class="fa fa-chart-line"></i><a href="#">Achievements</a>
                                </li>
                                <li><i class="fa fa-chart-bar"></i><a href="#">Auto Renewal</a></li>
                                <li><i class="fa fa-chart-line"></i><a href="#">Achievements</a>
                                </li>
                                <li><i class="fa fa-chart-area"></i><a href="#">Logout</a>
                                </li>
                            </ul>
