                                                    ...
                                                    <tr>
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                ...
                                                                @foreach($introLines as $line){{$line}}@endforeach
                                                            </small>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="alert alert-warning text-center">
                                                    @foreach ($outroLines as $line){{$line}}@endforeach
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <td>
                                                            <small>
                                                                @isset($actionText)
                                                                    ...
                                                                    "{{ $actionText }}" button below, copy and paste
                                                                    this URL [{{$actionUrl}}] into your web browser.
                                                                @endisset
                                                            </small>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" width="600" class="full-width"
                                                            style="padding-left: 20px; padding-right:20px;text-transform: uppercase"
                                                            valign="top">
                                                            <a class="zoom" id="activate" href="{{$actionUrl}}"
                                                               target="_blank">
                                                                {{ $actionText }}
                                                            </a>
                                                        </td>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="footer-padding"
                                                                        ...
                                                                        this message or contact {{env('MAIL_USERNAME')}} for
