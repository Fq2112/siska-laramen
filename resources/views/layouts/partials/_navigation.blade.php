<ul class="nav navbar-nav navbar-right">
    ...
    @auth
        ...
        <li class="call-to-action dropdown">
            <a style="cursor: pointer" id="external" class="{{ Auth::user()->role == 'agency' ? 'log-in' : 'sign-up' }}"
               data-toggle="dropdown">
                <span>
                    ...
                    <strong class="aj_name">{{Auth::user()->isSeeker() ? \Illuminate\Support\Str::words(Auth::user()->name, 2,"") : Auth::user()->name}}</strong>
                </span>
            </a>
